...
const faqItems = [
  {
    ...
    answer: "Baby Blobs are the first interactive NFT collection on Solana, made with love by a great team from all over the world!",
  },
  {
  ...
  },
  {
    ...
    answer: <div>We have an exclusive launch deal with <a href="https://ftx.us/nfts/collection/Baby%20Blobs/25/1">FTX</a>. They added support for our HTML standard, and you will be able to buy and sell Blobs on their marketplace!</div>,
  },
  {
  ...
  },
  {
    ...
    answer: <div>We added HTML file support to the official Solana NFT standard, so each Baby Blob is actually its own custom HTML file! Here's a sneak peak of how they will look on the <a href="https://explorer.solana.com/address/GThxoQB5Kdf4s9Ttzq9LHLtHGa9FqHupoTVXF2pHcVY7">Solana Explorer</a>!</div>
  },
  {
...
const CountDown = () => {
  ...
  return (<div className="block coming-soon">
    <div>Coming Soon</div>
    <div>
