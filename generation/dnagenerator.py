...
def createCombo():
    ...
    if os.path.exists(f"C:/Users/sammy/Desktop/blobs/generation/nfts/bases/{shape}/T{tier}/{blobColor}/{blobStyle}.png"):
...
def renderer(item):
    # if os.path.exists(f"C:/Users/sammy/Desktop/blobs/generation/nfts/images-id/{item['tokenId']}.png"):
    if os.path.exists(f"C:/Users/sammy/Desktop/blobs/generation/nfts/images-hex/{item['Random ID']}.png"):
        # if False:
        return 1
    else:
        # size of image
        ...
        _base = Image.open(
            f"C:/Users/sammy/Desktop/blobs/generation/nfts/bases/{shape}/T{tier}/{blobColor}/{blobStyle}.png").convert('RGBA')

        if tier == 3:
            _background = Image.open(
                f"C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/T3/{background}Bg.png").convert('RGBA')
        else:
            _background = Image.open(
                f"C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/T{tier}/{background}.png").convert('RGBA')

        _face = Image.open(
            f"C:/Users/sammy/Desktop/blobs/generation/nfts/faces/{faceColor}/{face}.png").convert('RGBA')

        output = _background.copy()
        output.paste(_base, area, _base)
        output.paste(_face, area, _face)
        if os.path.exists(f"C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/T{tier}/{background}Fg.png"):
            _foreground = Image.open(
                f"C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/T{tier}/{background}Fg.png").convert('RGBA')
            output.paste(_foreground, area, _foreground)
        #output.save(
         #   f"C:/Users/sammy/Desktop/blobs/generation/nfts/images-sorted/T{tier}-{blobStyle}-{shape}-{face}-{tokenId}.png")
        output.save(
            f"C:/Users/sammy/Desktop/blobs/generation/nfts/images-hex/{randomID}.png")
        '''
        output2 = _base.copy()
        output2.paste(_face,area,_face)
        output2.save(f"C:/Users/sammy/Desktop/blobs/generation/nfts/html/bases/{randomID}.png")

        output3 = _background.copy()
        output3.save(f"C:/Users/sammy/Desktop/blobs/generation/nfts/html/backgrounds/{randomID}.png")

        if os.path.exists(f"C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/{tier}/fg/{background}.png"):
            _foreground = Image.open(f"C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/{tier}/{background}Fg.png").convert('RGBA')
            output4 = _foreground.copy()
            output4.save(f"C:/Users/sammy/Desktop/blobs/generation/nfts/html/foregrounds/{randomID}.png")
        print(tokenId)
        '''
...
def oneofsrenderer(item):
    ...
    ID = item["ID"]
    _base = Image.open(
        f"C:/Users/sammy/Desktop/blobs/generation/nfts/1-1/bases/{blobStyle}.png").convert('RGBA')
    _background = Image.open(
        f"C:/Users/sammy/Desktop/blobs/generation/nfts/1-1/backgrounds/{blobStyle}.png").convert('RGBA')
    _face = Image.open(
        f"C:/Users/sammy/Desktop/blobs/generation/nfts/1-1/faces/{blobStyle}.png").convert('RGBA')

    output = _background.copy()
    output.paste(_base, area, _base)
    output.paste(_face, area, _face)
    if os.path.exists(f"C:/Users/sammy/Desktop/blobs/generation/nfts/1-1/foregrounds/{blobStyle}.png"):
        _foreground = Image.open(
            f"C:/Users/sammy/Desktop/blobs/generation/nfts/1-1/foregrounds/{blobStyle}.png").convert('RGBA')
        output.paste(_foreground, area, _foreground)
    #output.save(
     #   f"C:/Users/sammy/Desktop/blobs/generation/nfts/images-sorted/T4-{blobStyle}-{tokenId}.png")
    output.save(
        f"C:/Users/sammy/Desktop/blobs/generation/nfts/images-hex/{randomID}.png")
    output.save(
        f"C:/Users/sammy/Desktop/blobs/generation/nfts/ones/{ID}.png")
...
with open('C:/Users/sammy/Desktop/blobs/generation/nfts/combined-raw.json', 'w') as outfile:
