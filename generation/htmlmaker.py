...
def htmlmaker(trait):
    ...
    if trait["Tier"] == 4 and os.path.exists(f'C:/Users/sammy/Desktop/blobs/generation/nfts/1-1/foregrounds/{trait["Blob Style"]}.png'):
        with open(f'C:/Users/sammy/Desktop/blobs/generation/nfts/html/{trait["Random ID"]}.html', 'w') as f:
        #with open(f'C:/Users/sammy/Desktop/blobs/generation/nfts/html/{trait["Blob Style"]}.html', 'w') as f:
    ...
    elif trait["Tier"] == 3 and os.path.exists(f'C:/Users/sammy/Desktop/blobs/generation/nfts/backgrounds/T3/{trait["Background"]}Fg.png'):
        with open(f'C:/Users/sammy/Desktop/blobs/generation/nfts/html/{trait["Random ID"]}.html', 'w') as f:
            f.write(f"""<!DOCTYPE html>
        <html lang="en">
        <head>
    ...
    # if os.path.exists(f'C:/Users/sammy/Desktop/blobs/generation/nfts/foregrounds/{name}.png'):
traitsfile = open(
    'C:/Users/sammy/Desktop/blobs/generation/nfts/combined-raw.json', 'r')
