...
for trait in traits:
    ...
    jsons.append(blob)
    with open(f'C:/Users/sammy/Desktop/blobs/generation/nfts/json-hex/{randomID}.json', 'w') as outfile:
        json.dump(blob, outfile, indent=4)
    print(counter)
    counter = counter + 1

with open('C:/Users/sammy/Desktop/blobs/generation/nfts/traits.json', 'w') as outfile:
